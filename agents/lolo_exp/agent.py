...
class EXP_sym(AbstractAgent):
    ...
    def update_operate(
        ...
        fb_loss, metrics, F1, F2, B_next, B_rand, _, _, actor_std_dev, dormant_indices, auxiliary_loss = self._update_operate_inner(
        ...
        if self.use_cons:
            ...
            total_loss = fb_loss + conservative_loss
